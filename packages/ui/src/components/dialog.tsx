      ...
      >
        ...
        {showCloseButton ? (
          <DialogPrimitive.Close
            ...
            className="absolute top-4 right-4 rounded-md text-muted-foreground opacity-70 transition-opacity hover:opacity-100 focus:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:pointer-events-none"
            aria-label="Close"
          >
...
function DialogTitle({ className, ...props }: DialogPrimitive.Title.Props) {
  return (
    <DialogPrimitive.Title
      ...
      className={cn("font-heading font-medium text-sm leading-none", className)}
      {...props}
    />
  )
}
